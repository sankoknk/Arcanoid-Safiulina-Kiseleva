...
# score = 0
# class Game:
#     def draw_lives(lives_t):
#         lives_t = font.render(f"Lives: {lives}", True, (255, 255, 255))
#         screen.blit(lives_t, (10, 10))
#
#     def draw_score(score_t):
...
#             screen.blit(self.game_over_text, (screen_w // 2 - 100, screen_h // 2))
